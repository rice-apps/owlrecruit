...
import { processAndUploadApplications, UploadResult } from "@/lib/csv-upload-utils";
...
export async function POST(
  ...
  try {
    ...
    const { csvData, columnMappings, customQuestions, existingApplicants: existingApplicantsObj } = body;
    ...
    let existingApplicantsMap: Map<string, { applicantId: string; name: string }> | undefined = undefined;
