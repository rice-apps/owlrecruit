...
export function UploadTab() {
  ...
  const isStep3Valid = columnMappings.name !== "" && columnMappings.netid !== "";
          ...
          <>
            ...
            <div 
              className={cn(
                ...
                isDragOver ? "border-cyan-500 bg-cyan-50" : "border-gray-200 bg-gray-50/50"
              )}
                    ...
                    <Dialog open={isQuestionModalOpen} onOpenChange={setIsQuestionModalOpen}>
                      ...
                      <DialogContent>
                        ...
                        <DialogFooter>
                          ...
                          <Button onClick={handleAddQuestion} className="bg-cyan-500 hover:bg-cyan-600">Add Question</Button>
                        </DialogFooter>
                      </DialogContent>
                    </Dialog>
                 </div>
              ...
              <div>
                ...
                <div className="space-y-2 max-w-md">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900">{columnMappings.name}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">NetID:</span>
                    <span className="font-medium text-gray-900">{columnMappings.netid}</span>
                  </div>
                  {columnMappings.year && (
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">Year:</span>
                      <span className="font-medium text-gray-900">{columnMappings.year}</span>
                    </div>
                  )}
                  {columnMappings.major && (
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">Major:</span>
                      <span className="font-medium text-gray-900">{columnMappings.major}</span>
                    </div>
                  )}
                  {customQuestions.map((q) => (
                    columnMappings[q.id] && (
                      <div key={q.id} className="flex justify-between text-sm">
                        ...
                        <span className="font-medium text-gray-900">{columnMappings[q.id]}</span>
                      </div>
                    )
                  ))}
                </div>
