...
import { getOpeningData } from "@/lib/data/openings";
...
export default async function OpeningOverviewPage({
  ...
  // Fetch data using shared data function
  const { org: orgData, opening: openingData, applicants: rawApplicants } =
    await getOpeningData(orgId, openingId);
